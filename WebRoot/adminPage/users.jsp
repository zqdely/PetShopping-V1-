      ...
      <s:if test="isadmin!=1">
          ...
          <td>
              ...
              <script type="text/javascript">
              	     function onclickb(){
              		    if(confirm("确定删除吗？")){
              			    location.href="delete?id=<s:property value='id'/>";
              		    }
              	     }
              </script>         
          </td>
...
<div class="pagination">
    ...
    <a href="page?currpageNo=1">首页</a>&nbsp;&nbsp;
  	<a href="page?currpageNo=<s:property value='currpageNo>1?currpageNo-1:1'/>">上一页</a>&nbsp;&nbsp;
  	<a href="page?currpageNo=<s:property value='currpageNo==totalPageCount?currpageNo:currpageNo+1'/>">下一页</a>&nbsp;&nbsp;
  	<a href="page?currpageNo=<s:property value="totalPageCount"/>">末尾页</a>
