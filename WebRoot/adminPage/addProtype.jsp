...
<body class="">
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li class="active">添加商品种类</li>
		</ul>

		<div class="container-fluid">
			<div class="row-fluid">
                <div class="btn-toolbar">
				    <button class="btn">添加商品种类</button>
				...
				<div class="well">
		            ...
		            <div class="block-body">
		                <form enctype="multipart/form-data" method="post" action="addProtype.action">
		                    <label>宠物种类名称</label>
		                    <input type="text" name="protype.protypename"><br/>
