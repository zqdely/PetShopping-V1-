...
<div class="well">
    <table class="table">
      ...
      <tbody>
      <s:iterator value="valuations">
      <tr>
          <td><s:property value="content"/></td>
          <td><s:property value="userinfo.name"/></td>
          <s:if test="dog!=null"><td><s:property value="dog.info"/></td></s:if><s:else><td><s:property value="products.info"/></td></s:else>
          <td>
              <a href="#"><i class="icon-remove"  id="delete" onclick="javascript:onclickb()" ></i></a>
              <script type="text/javascript">
              	     function onclickb(){
              		    if(confirm("确定删除吗？")){
              			    location.href="deleteValuation?id=<s:property value='id'/>";
              		    }
              	     }
              </script>          
          </td>
...
<div class="pagination">
    ...
    <a href="findValuations?currpageNo=1">首页</a>&nbsp;&nbsp;
  	<a href="findValuations?currpageNo=<s:property value='currpageNo>1?currpageNo-1:1'/>">上一页</a>&nbsp;&nbsp;
  	<a href="findValuations?currpageNo=<s:property value='currpageNo==totalPageCount?currpageNo:currpageNo+1'/>">下一页</a>&nbsp;&nbsp;
  	<a href="findValuations?currpageNo=<s:property value="totalPageCount"/>">末尾页</a>
