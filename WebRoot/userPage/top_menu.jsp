...
<div class="header">
							...
							<div class="h_nav">
								...
								<ul>
									<%
										for(Protype product:protype){
										%>
										<li><a href="dogOrproducts.action?ptypeid=<%=product.getProtypeid() %>"><%=product.getProtypename() %></a></li>
										<%
										}
									 %>
								</ul>	
     ...
     <div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >企业网站模板</a></div>
		 <div class="caption">
		 <h1>CW 吉祥宠物商店 SHOPPING</h1>	 
		 <p>本店专门为宠物提供宠物用品零售、宠物美容、宠物寄养、宠物活体销售的场所。
		 其经营项目一般包括宠物用品超市、活体销售、宠物美容、宠物寄养、宠物医疗、宠物乐园、宠物摄影、待产养护。有时宠物店又等同于宠物用品店、宠物美容店、宠物寄存、宠物医院、宠物驯养等。</p>
	     </div>
</div>
