...
<body class="">
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li class="active">添加宠物种类</li>
		</ul>

		<div class="container-fluid">
			<div class="row-fluid">
                <div class="btn-toolbar">
				    <button class="btn">添加宠物种类</button>
				...
				<div class="well">
		            ...
		            <div class="block-body">
		                <form enctype="multipart/form-data" method="post" action="addDogType">
		                    <label>宠物种类名称</label>
		                    <input type="text" name="type.typename">
