        ...
        <div class="span9">
            <div class="search-well">
                <form class="form-inline">
                    <input class="input-xlarge" placeholder="搜索帮助内容" id="appendedInputButton" type="text">
                    <button class="btn" type="button"><i class="icon-search"></i> 提交</button>
                </form>
            </div>

            <div class="block">
                <p class="block-heading">最受欢迎的宠物</p>
